...
public class CompanyBuilder {
    ...
    public static Company buildSimple() {
        try {
            ...
            Company company = new Company(88, "百度时代网络技术(北京)有限公司", dateFormat.parse("2000-11-11"),
                    departmentList1);
            return company;
    ...
    public static List<Company> buildMulti() {
        try {
            ...
            Company company1 = new Company(88, "百度时代网络技术(北京)有限公司", dateFormat.parse("2000-11-11"),
                    departmentList1);
